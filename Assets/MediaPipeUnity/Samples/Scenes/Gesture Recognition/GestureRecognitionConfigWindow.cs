...
namespace Mediapipe.Unity.Sample.GestureRecognition.UI
{
  public class GestureRecognitionConfigWindow : ModalContents
  {
    ...
    private GestureRecognitionConfig _config;
    private bool _isChanged;

    private void Start()
    {
      _config = GameObject.Find("Solution").GetComponent<GestureRecognizerRunner>().config;
      InitializeContents();
    }
